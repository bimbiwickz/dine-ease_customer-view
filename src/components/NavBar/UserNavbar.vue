<template>
    ...
    <nav :class="{ 'bg-transparent': isNavbarTransparent, 'bg-white': !isNavbarTransparent }"
    class="fixed top-0 bg-transparent flex-no-wrap fixed flex w-full items-center justify-between py-2 shadow-md shadow-black/5 lg:flex-wrap lg:justify-start lg:py-4
    data-te-navbar-ref">
    <div class="flex w-full flex-wrap items-center justify-between px-3">
        ...
        class="list-style-none flex flex-col ml-[1100px] lg:flex-row"
            ...
            <!-- Dashboard link -->
            <a
                class="text-white transition duration-200 hover:text-green hover:ease-in-out focus:text-neutral-700 disabled:text-black/30 motion-reduce:transition-none lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-zinc-400"
                href="/"
    ...
    export default defineComponent({
        setup(){
            ...
            const handleScroll = () => {
                ...
                isNavbarTransparent.value = scrollPosition === 0;
            };
