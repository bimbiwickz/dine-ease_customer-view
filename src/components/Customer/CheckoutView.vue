            		...
            		<div class="col-span-2 p-5">
            			<div class="flex justify-between items-center mt-6 pt-6 text-black">
            				<div class="flex  items-center">
            					<img src="https://www.archanaskitchen.com/images/archanaskitchen/1-Author/shaikh.khalid7-gmail.com/Chicken_Momos_Recipe_Delicious_Steamed_Chicken_Dumplings.jpg" width="60" class="rounded-full ">
            				...
            				<div class="flex justify-center items-center">
            					...
            					<div class="pr-8 flex ">
            						<input type="number" class="focus:outline-none bg-gray-100 border h-6 w-8 rounded text-sm px-2 mx-2" value="1" readonly>
            					</div>
            			...
            			<div class="flex justify-between items-center mt-6 pt-6 border-t text-black">
            				<div class="flex  items-center">
            					<img src="https://dishingouthealth.com/wp-content/uploads/2020/08/SummerPanzanella_Square.jpg" width="60" class="rounded-full ">

            					<div class="flex flex-col ml-3 ">
            						<span class="text-md font-medium">Panzenella</span>
            				...
            				<div class="flex justify-center items-center ">
            					...
            					<div class="pr-8 flex">
            						<input type="text" class="focus:outline-none bg-gray-100 border h-6 w-8 rounded text-sm px-2 mx-2" value="4" readonly>
            					</div>
