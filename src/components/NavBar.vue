<template>
    ...
    <div class="flex w-full flex-wrap items-center justify-between px-3">
        <div>
        <a
            class="mx-1 my-1 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 lg:mb-0 lg:mt-0"
            href="#">
            <img
            class="mr-2"
        ...
        <div class="flex items-center">
            <a href="/login">
                ...
                class="mr-3 inline-block px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-green transition duration-150 ease-in-out bg-white rounded-full hover:text-black">
                Login 
                </button>
            </a>
            <a href="/signup">
